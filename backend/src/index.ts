...
app.get("/api/v1/userInfo",auth, async(req:Request,res:Response)=>{
    const userData=req.user;
    res.json(userData)
})

app.post("/api/v1/addExpense",auth,async(req:Request,res)=>{
    //get all the data
...
app.get("/api/v1/fetchExpense", auth, async(req: Request, res: Response) => {
    try {
...
app.post("/api/v1/expenses/bulkDelete",auth,async(req:Request<{},{},BulkDeleteBody>,res:Response)=>{
